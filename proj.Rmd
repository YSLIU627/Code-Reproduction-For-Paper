...
alpha <-CD_each_iter(sample_p = p.uniform,A = A.mushrooms,y = y.mushrooms,lambda = 0.05,step0 = 0.2,alpha = alpha1)
...
y = A%*%alpha1
alpha = numeric(d)
alpha <- CD_each_iter(sample_p = p.uniform,A = A,y = y,lambda = 0.05,step0 = 0.5,alpha = alpha1+100*rnorm(d))
print(sum((alpha-alpha1)**2))
